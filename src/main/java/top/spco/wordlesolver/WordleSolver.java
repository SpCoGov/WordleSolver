...
public class WordleSolver {
    ...
    public WordleSolver(int length) {
        this.length = length;
    }
    ...
    public WordleSolver setLetter(int letterPos, char c) {
    ...
    public WordleSolver setLetter(int letterPos, String cs) {
        return setLetter(letterPos, stringToChars(cs, true)[0]);
    }

    public WordleSolver notHave(char... cs) {
    ...
    public WordleSolver notHave(String cs) {
        return notHave(stringToChars(cs, false));
    }

    public WordleSolver cannotBe(int letterPos, char... cs) {
        if (!isValidPos(letterPos)) {
            return this;
        }
    ...
    public WordleSolver cannotBe(int letterPos, String chars) {
        return cannotBe(letterPos, stringToChars(chars, false));
    }

    public WordleSolver hasWord(char... cs) {
        for (char c : cs) {
            hasWords.add(c);
        }
        return this;
    ...
    public WordleSolver hasWord(String cs) {
        return hasWord(stringToChars(cs, false));
    }

    public WordleSolver yellowBlock(int letterPos, char c) {
        cannotBe(letterPos, c);
        hasWord(c);
        return this;
    }

    public WordleSolver yellowBlock(int letterPos, String cs) {
    ...
    public WordleSolver yellowBlock(String word) {
        if (word == null) {
            return this;
        }
    ...
    public WordleSolver mustBe(String word) {
        if (word == null) {
            return this;
        }
        if (word.length() > this.length) {
    ...
    public WordleSolver guess(String guessResult) {
